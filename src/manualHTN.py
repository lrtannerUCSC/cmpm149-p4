...
pyhop.declare_operators (op_punch_for_wood, op_craft_wooden_axe_at_bench, op_craft_plank, op_craft_bench, op_craft_stick, op_wooden_axe_for_wood)
...
# state.time = {'agent': 4}
state.time = {'agent': 46} # needs to beat 46
